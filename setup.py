...
setup(
    ...
    url="https://github.com/reversefold/pyReaderWriterLock",
    download_url="https://github.com/reversefold/pyReaderWriterLock",
    ...
    project_urls={
        'Source': 'https://github.com/reversefold/pyReaderWriterLock',
        'Tracker': 'https://github.com/reversefold/pyReaderWriterLock/issues'
    },
    install_requires=[],
    python_requires='>=2.7'
)
